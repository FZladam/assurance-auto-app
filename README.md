...
- `soumission.html` : première étape du formulaire.
- `soumission2.html` : deuxième étape du formulaire.
- `soumission3.html` : dernière étape du formulaire
...
- `style.css` : contient la mise en page et l'adaptation pour tablette.
